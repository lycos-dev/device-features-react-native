    ...
    <View style={[styles.container, { backgroundColor: "#000" }]}>
      ...
      >
        ...
        <View style={styles.photoSection}>
          ...
          <View style={styles.photoBottom} onLayout={handleBottomBlockLayout}>
...
const styles = StyleSheet.create({
  ...
  photoSection: { width: W, height: H, backgroundColor: "#000" },
  ...
  photoBottom: {
    position: "absolute", bottom: 0, left: 0, right: 0,
    paddingHorizontal: 20, paddingBottom: 36, gap: 20,
  },
  photoTitle: { gap: 8 },
  issueBadge: { flexDirection: "row", alignItems: "center", gap: 6 },
  issueDot: { color: "rgba(255,255,255,0.6)", fontSize: 11 },
  issueText: {
  ...
  swipeHint: { alignItems: "center", gap: 4 },
  swipeArrow: { color: "rgba(255,255,255,0.7)", fontSize: 16 },
  swipeText: {
    color: "rgba(255,255,255,0.55)", fontSize: 11,
    fontWeight: "500", letterSpacing: 0.3,
  },

  detailsPanel: { borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingTop: 12 },
  ...
  noteBox: { borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, padding: 14 },
  noteText: { fontSize: 14, lineHeight: 22, fontStyle: "italic" },
  refText: { fontSize: 11, letterSpacing: 0.3 },

  backBtnWrap: { position: "absolute", left: 16 },
  deleteBtnWrap: { position: "absolute", right: 16 },
  floatBtn: { width: 40, height: 40, borderRadius: 20, overflow: "hidden" },
  floatBtnInner: {
    width: "100%", height: "100%",
    alignItems: "center", justifyContent: "center",
  },
  floatBtnText: { fontSize: 18, fontWeight: "400" },
});